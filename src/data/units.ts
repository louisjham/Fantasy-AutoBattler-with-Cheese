...
export const SUMMONS: Partial<Unit>[] = [
  // FIRE summons
  {
    ...
    stats: { hp: 45, maxHp: 45, attack: 12, defense: 3, speed: 2, mana: 0, maxMana: 100 },
  ...
  // DEATH summons
  {
    ...
    stats: { hp: 50, maxHp: 50, attack: 11, defense: 5, speed: 1, mana: 0, maxMana: 100 },
  ...
  // NATURE summons
  {
    ...
    stats: { hp: 42, maxHp: 42, attack: 10, defense: 4, speed: 3, mana: 0, maxMana: 100 },
  ...
  // ARCANE summons
  {
    ...
    stats: { hp: 35, maxHp: 35, attack: 9, defense: 3, speed: 2, mana: 30, maxMana: 100 },
